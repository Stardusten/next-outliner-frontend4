 ...
 * @category Usage
 */
export type { ModelUsageType, ModelTag } from "./model-usage";
...
export type { APIv1Options } from "./api-v1";
...
function LLMShortHandImpl(
  ...
  const response = llm.send() as Promise<
    string | Response | PartialStreamResponse
  >;
  return response;
}
